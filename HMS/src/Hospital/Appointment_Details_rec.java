...
public class Appointment_Details_rec extends javax.swing.JFrame {
    PlaceHolder p1;
    Connection conn = null;
    PreparedStatement pst = null;
    ResultSet rs = null;
    
    public Appointment_Details_rec() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Appointment_Details_rec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
